...
{
    /// <summary>
    /// Structure used to represent the NTSTATUS codes returned by many NT APIs.
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    public readonly struct NtStatus : IEquatable<NtStatus>
    {
        /// <summary>
        /// Contains the raw status code value (may not map to one we know).
        /// </summary>
        private readonly uint m_statusCodeValue;

        /// <nodoc />
        public NtStatus(uint statusCode)
        {
            m_statusCodeValue = statusCode;
        }

        /// <summary>
        /// Corresponding <see cref="NtStatusCode" /> for the raw <see cref="m_statusCodeValue" />, if one is defined.
        /// </summary>
        public NtStatusCode? StatusCode
        {
            get
            {
                NtStatusCode convertedStatusCode;
                if (EnumTraits<NtStatusCode>.TryConvert(m_statusCodeValue, out convertedStatusCode))
                {
        ...
        /// <summary>
        /// Gets whether or not this is a successful status code, like the <c>NT_SUCCESS</c> macro.
        /// </summary>
        public bool IsSuccessful
        {
            get { return unchecked((int)m_statusCodeValue) >= 0; }
        }
        ...
        {
            NtStatusCode? statusCode = StatusCode;
            return statusCode?.ToString("G") ?? I($"NTSTATUS:0x{m_statusCodeValue:X8}");
        }

        /// <inheritdoc />
        public bool Equals(NtStatus other)
        {
            return other.m_statusCodeValue == m_statusCodeValue;
        }

        /// <inheritdoc />
        public override int GetHashCode()
        {
            return m_statusCodeValue.GetHashCode();
        }
    ...
    /// <summary>
    /// NT status values as defined in ntstatus.h.
    /// </summary>
    public enum NtStatusCode : uint
    {
        /* Hidden, since it has the same value as StatusSuccess
        ///<summary>
        ...
        /* Hidden, since it has the same value as StatusAbandonedWait0
        //
        ...
        /// MessageText:
        ///
        /// This success level status indicates that the transaction state already exists for the registry sub-tree, but that a transaction commit was previously aborted. The commit has now
        /// been completed.
        /// </summary>
        ...
        /// A serial I/O operation completed because the time-out period expired. (The IoctlSerialXoffCounter had not reached zero.,
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The CPUs in this multiprocessor system are not all the same revision level. To use all processors the operating system restricts itself to the features of the least capable
        /// processor in the system. Should problems occur with this system, contact the Cpu manufacturer to see if this mix of processors is supported.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The attempt to commit the Transaction completed, but it is possible that some portion of the transaction tree did not commit successfully due to heuristics.  Therefore it is
        /// possible that some data modified in the transaction may not have committed, resulting in transactional inconsistency.  If possible, check the consistency of the associated data.
        /// </summary>
        ...
        ///
        /// {Guid Substitution}
        /// During the translation of a global identifier (Guid, to a Windows security Id (Sid,, no administratively-defined Guid prefix was found. A substitute prefix was used, which will
        ...
        /// MessageText:
        ///
        /// The application is attempting to run executable code from the module %hs. This may be insecure. An alternative, %hs, is available. Should the application use the secure module
        /// %hs?
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The application is loading executable code from the module %hs. This is secure, but may be incompatible with previous releases of the operating system. An alternative, %hs, is
        ...
        /// MessageText:
        ///
        /// An attempt to set a process's DebugPort or ExceptionPort was made, but a port already exists in the process or an attempt to set a file's CompletionPort made, but a port was
        /// already set in the file or an attempt to set an Alpc port's associated completion port was made, but it is already set.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// Indicates a referenced user name and authentication information are valid, but some user account restriction has prevented successful authentication (such as time-of-day
        /// restrictions,.
        /// </summary>
        ...
        ///
        /// {Bad Image}
        /// %hs is either not designed to run on Windows or it contains an error. Try installing the program again using the original installation media or contact your system administrator
        ...
        /// MessageText:
        ///
        /// When a block of memory is allotted for future updates, such as the memory allocated to hold discretionary access control and primary group information, successive updates may
        ...
        /// Instead, a request that requires more memory than has been allotted must fail and the StatusAllotedSpaceExceeded error returned.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// An access to a user buffer failed at an "expected" point in time. This code is defined since the caller does not want to accept StatusAccessViolation in its filter.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// If an I/O error is returned which is not defined in the standard FsRtl filter, it is converted to the following error which is guaranteed to be in the filter. In this case
        ...
        /// MessageText:
        ///
        /// If an Mm error is returned which is not defined in the standard FsRtl filter, it is converted to one of the following errors which is guaranteed to be in the filter. In this case
        /// information is lost, however, the filter correctly handles the exception.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// Indicates that an attempt was made to assign protection to a file system file or directory and one of the SIDs in the security descriptor could not be translated into a Guid that
        /// could be stored by the file system.
        ...
        /// MessageText:
        ///
        /// Indicates that the transaction state of a registry sub-tree is incompatible with the requested operation. For example, a request has been made to start a new transaction with one
        /// already in progress, or a request has been made to apply a transaction when one is not currently in progress.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// Indicates an error has occurred during a registry transaction commit. The database has been left in an unknown, but probably inconsistent, state. The state of the registry
        ...
        /// MessageText:
        ///
        /// An I/O request other than close was performed on a file after it has been deleted, which can only happen to a request which did not complete before the last handle was closed via
        /// NtClose.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The NtCreateFile Api failed. This error should never be returned to an application, it is a place holder for the Windows Lan Manager Redirector to use in its internal error
        /// mapping routines.
        /// </summary>
        ...
        /// The remote computer has insufficient resources to complete the network request. For instance, there may not be enough memory available on the remote computer to carry out the
        ...
        ///
        /// {Virtual Circuit Closed}
        /// An existing connection (virtual circuit, has been broken at the remote computer. There is probably something wrong with the network software protocol or the network hardware on
        /// the remote computer.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// {Unable to CreateSourceFile Paging File}
        ...
        /// The structure of one of the files that contains Registry data is corrupt, or the image of the file in memory is corrupt, or the file could not be recovered because the alternate
        ...
        /// MessageText:
        ///
        /// An I/O operation initiated by the Registry failed unrecoverably. The Registry could not read in, or write out, or flush, one of the files that contain the system's image of the
        /// Registry.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The maximum number of secrets that may be stored in a single system has been exceeded. The length and number of secrets is limited to satisfy United States State Department export
        /// restrictions.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// During a logon attempt, the user's security context accumulated too many security IDs. This is a very unusual situation. Remove the user from some global or local groups to reduce
        ...
        /// MessageText:
        ///
        /// A user has requested a type of logon (e.g., interactive or network, that has not been granted. An administrator has control over who may logon interactively and through the
        /// network.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// An illegal character was encountered. For a multi-byte character set this includes a lead byte without a succeeding trail byte. For the Unicode character set this includes the
        ...
        /// Windows was unable to save all the data for the file %hs. The data has been lost. This error may be caused by a failure of your computer hardware or network connection. Please try
        ...
        /// MessageText:
        ///
        /// Internal Ofs status codes indicating how an allocation operation is handled. Either it is retried after the containing onode is moved or the extent stream is converted to a large
        /// stream.
        /// </summary>
        ...
        /// The dynamic link library %hs is not written correctly. The stack pointer has been left in an inconsistent state. The entrypoint should be declared as Winapi or Stdcall. Select Yes
        /// to fail the Dll load. Select No to continue execution. Selecting No may cause the application to operate incorrectly.
        /// </summary>
        ...
        /// The %hs service is not written correctly. The stack pointer has been left in an inconsistent state. The callback entrypoint should be declared as Winapi or Stdcall. Selecting Ok
        /// will cause the service to continue operation. However, the service process may operate incorrectly.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The service being accessed is licensed for a particular number of connections. No more connections can be made to the service at this time because there are already as many
        /// connections as the service can accept.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The policy of your user account does not allow you to change passwords too frequently. This is done to prevent users from changing back to a familiar, but potentially discovered,
        /// password. If you feel your password has been compromised then please contact your administrator immediately to have a new one assigned.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// You have attempted to change your password to one that you have used in the past. The policy of your user account does not allow this. Please select a password that you have not
        /// previously used.
        /// </summary>
        ...
        /// The evaluation period for this installation of Windows has expired. This system will shutdown in 1 hour. To restore access to this installation of Windows, please upgrade this
        ...
        /// The system Dll %hs was relocated in memory. The application will not run properly. The relocation occurred because the Dll %hs occupied an address range reserved for Windows
        ...
        /// MessageText:
        ///
        /// Your computer could not be joined to the domain. You have exceeded the maximum number of computer accounts you are allowed to create in this domain. Contact your system
        ...
        /// MessageText:
        ///
        /// An attempt was made by this server to make a Kerberos constrained delegation request for a target outside of the server's realm. This is not supported, and indicates a
        /// misconfiguration on this server's allowed to delegate to list. Please contact your administrator.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The revocation status of the domain controller certificate used for smartcard authentication could not be determined. There is additional information in the system event log.
        ...
        /// MessageText:
        ///
        /// An untrusted certificate authority was detected while processing the domain controller certificate used for authentication. There is additional information in the system event
        ...
        /// The %hs display driver has stopped working normally. Save your work and reboot the system to restore full display functionality. The next time you reboot the machine a dialog will
        ...
        /// MessageText:
        ///
        /// Windows cannot verify the digital signature for this file. A recent hardware or software change might have installed a file that is signed incorrectly or damaged, or that might be
        ...
        /// MessageText:
        ///
        /// The Filter Manager had an internal error from which it cannot recover, therefore the operation has been failed. This is usually the result of a filter returning an invalid value
        /// from a pre-operation callback.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The Transaction object already has a superior enlistment, and the caller attempted an operation that would have created a new superior. Only a single superior enlistment is
        /// allowed.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The handle has been invalidated by a transaction. The most likely cause is the presence of memory mapping on a file or an open handle when the transaction ended or rolled back to
        /// savepoint.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The object specified could not be created or opened, because its associated TransactionManager is not online.  The TransactionManager must be brought fully Online by calling
        /// RecoverTransactionManager to recover to the end of its LogFile before objects in its Transaction or ResourceManager namespaces can be opened.  In addition, errors in writing
        /// records to its LogFile can cause a TransactionManager to go offline.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The call to create a superior Enlistment on this Transaction object could not be completed, because the Transaction object specified for the enlistment is a subordinate branch of
        /// the Transaction. Only the root of the Transaction can be enlisted on as a superior.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The specified operation could not be performed on this Superior enlistment, because the enlistment was not created with the corresponding completion response in the
        /// NotificationMask.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The specified operation could not be performed, because the record that would be logged was too long. This can occur because of two conditions:  either there are too many
        /// Enlistments on this Transaction, or the combined RecoveryInformation being logged on behalf of those Enlistments is too long.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The transaction cannot be enlisted on with the specified EnlistmentMask, because the transaction has already completed the PrePrepare phase.  In order to ensure correctness, the
        /// ResourceManager must switch to a write-through mode and cease caching data within this transaction.  Enlisting for only subsequent transaction phases may still succeed.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The handle is no longer properly associated with its transaction.  It may have been opened in a transactional resource manager that was subsequently forced to restart.  Please
        /// close the handle and open a new one.
        /// </summary>
        ...
        /// {Display Driver Stopped Responding}
        /// The %hs display driver has stopped working normally. Save your work and reboot the system to restore full display functionality. The next time you reboot the machine a dialog will
        /// be displayed giving you a chance to upload data about this failure to Microsoft.
        /// </summary>
        ...
        /// The %hs display driver has detected and recovered from a failure. Some graphical operations may have failed. The next time you reboot the machine a dialog will be displayed giving
        ...
        /// MessageText:
        ///
        /// Specified buffer is not big enough to contain entire requested dataset. Partial data populated upto the size of the buffer. Caller needs to provide buffer of size as specified in
        /// the partially populated buffer's content (interface specific,.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The operating system asynchronously destroyed this Opm protected output because the operating system's state changed. This error typically occurs because the monitor Pdo
        /// associated with this protected output was removed, the monitor Pdo associated with this protected output was stopped, or the protected output's session became a non-console
        /// session.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// Either the DxgkDdiOPMGetCOPPCompatibleInformation, DxgkDdiOPMGetInformation, or DxgkDdiOPMConfigureProtectedOutput function failed. This error is returned when the caller tries to
        ...
        /// MessageText:
        ///
        /// The DxgkDdiOPMGetInformation and DxgkDdiOPMGetCOPPCompatibleInformation functions return this error code if the passed in sequence number is not the expected sequence number or
        ...
        ///
        /// Either the DxgkDdiOPMGetCOPPCompatibleInformation, DxgkDdiOPMGetInformation, or DxgkDdiOPMConfigureProtectedOutput function failed. This error is returned when the caller tries to
        /// use an Opm specific command while the protected output has Copp semantics only.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The DxgkDdiOPMGetCOPPCompatibleInformation and DxgkDdiOPMConfigureProtectedOutput functions return this error if the display driver does not support the
        /// DxgkmdtOpmGetAcpAndCgmsaSignaling and DxgkmdtOpmSetAcpAndCgmsaSignaling GUIDs.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The DxgkDdiOPMConfigureProtectedOutput function returns this error code if the passed in sequence number is not the expected sequence number or the passed in Omac value is
        /// invalid.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The function failed because a monitor returned an invalid Timing Status byte when the operating system used the Ddc/Ci Get Timing Report and Timing Message command to get a timing
        /// report from a monitor.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// An error occurred because the checksum field in a Ddc/Ci message did not match the message's computed checksum value. This error implies that the data was corrupted while it was
        ...
        /// MessageText:
        ///
        /// The operating system asynchronously destroyed the monitor which corresponds to this handle because the operating system's state changed. This error typically occurs because the
        /// monitor Pdo associated with this handle was removed, the monitor Pdo associated with this handle was stopped, or a display mode change occurred. A display mode change occurs when
        /// windows sends a WmDisplaychange windows message to applications.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// This function can only be used if a program is running in the local console session. It cannot be used if a program is running on a remote desktop session or on a terminal server
        /// session.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The function failed because an invalid pointer parameter was passed to it. A pointer parameter is invalid if it is Nul, it points to an invalid address, it points to a kernel mode
        /// address or it is not correctly aligned.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The function failed because the current session is changing its type. This function cannot be called when the current session is changing its type. There are currently three types
        /// of sessions: console, disconnected and remote.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The handler for the virtualization infrastructure driver is already registered. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the
        /// physical computer.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The number of registered handlers for the virtualization infrastructure driver exceeded the maximum. Restarting the virtual machine may fix the problem. If the problem persists,
        ...
        /// MessageText:
        ///
        /// The message queue for the virtualization infrastructure driver is full and cannot accept new messages. Restarting the virtual machine may fix the problem. If the problem persists,
        /// try restarting the physical computer.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// No handler exists to handle the message for the virtualization infrastructure driver. Restarting the virtual machine may fix the problem. If the problem persists, try restarting
        ...
        /// MessageText:
        ///
        /// The name of the partition or message queue for the virtualization infrastructure driver is invalid. Restarting the virtual machine may fix the problem. If the problem persists,
        /// try restarting the physical computer.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The virtualization infrastructure driver has encountered an error. The requested partition does not exist. Restarting the virtual machine may fix the problem. If the problem
        ...
        /// MessageText:
        ///
        /// The virtualization infrastructure driver has encountered an error. Could not find the requested partition. Restarting the virtual machine may fix the problem. If the problem
        /// persists, try restarting the physical computer.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The memory block page for the virtualization infrastructure driver cannot be mapped because the page map limit has been reached. Restarting the virtual machine may fix the
        ...
        /// MessageText:
        ///
        /// Cannot unlock the page array for the guest operating system memory address because it does not match a previous lock request. Restarting the virtual machine may fix the problem.
        ...
        /// For detailed information, see http://go.microsoft.com/fwlink/?LinkId=92362.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The request exceeded the memory block page limit for the virtualization infrastructure driver. Restarting the virtual machine may fix the problem. If the problem persists, try
        ...
        /// MessageText:
        ///
        /// The request to lock or map a memory block page failed because the virtualization infrastructure driver memory block limit has been reached. Restarting the virtual machine may fix
        /// the problem. If the problem persists, try restarting the physical computer.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The message queue for the virtualization infrastructure driver has been closed. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the
        /// physical computer.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The maximum number of kernel mode clients for the virtualization infrastructure driver has been reached. Restarting the virtual machine may fix the problem. If the problem
        /// persists, try restarting the physical computer.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// This kernel mode interface for the virtualization infrastructure driver has already been initialized. Restarting the virtual machine may fix the problem. If the problem persists,
        /// try restarting the physical computer.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// Cannot set or reset the memory block property more than once for the virtualization infrastructure driver. Restarting the virtual machine may fix the problem. If the problem
        /// persists, try restarting the physical computer.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The lock or unlock request uses an invalid guest operating system memory address. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the
        /// physical computer.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// Cannot destroy or reuse the reserve page set for the virtualization infrastructure driver because it is in use. Restarting the virtual machine may fix the problem. If the problem
        /// persists, try restarting the physical computer.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The reserve page set for the virtualization infrastructure driver is too small to use in the lock request. Restarting the virtual machine may fix the problem. If the problem
        /// persists, try restarting the physical computer.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// Cannot lock or map the memory block page for the virtualization infrastructure driver because it has already been locked using a reserve page set page. Restarting the virtual
        ...
        /// MessageText:
        ///
        /// Cannot create the memory block for the virtualization infrastructure driver because the requested number of pages exceeded the limit. Restarting the virtual machine may fix the
        /// problem. If the problem persists, try restarting the physical computer.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// A virtual machine is running with its memory allocated across multiple Numa nodes. This does not indicate a problem unless the performance of your virtual machine is unusually
        /// slow. If you are experiencing performance problems, you may need to modify the Numa configuration. For detailed information, see http://go.microsoft.com/fwlink/?LinkId=92362.
        /// </summary>
        ...
        /// MessageText:
        ///
        /// The requested operation could not be completed due to a virtual disk system limitation.  Virtual disks are only supported on Ntfs volumes and must be both uncompressed and
        /// unencrypted.
        /// </summary>
