...
#ifdef UNICODE
#define DetourCreateProcessWithDllx86x64  DetourCreateProcessWithDllx86x64W
#else
#define DetourCreateProcessWithDllx86x64  DetourCreateProcessWithDllx86x64A
#endif // !UNICODE
